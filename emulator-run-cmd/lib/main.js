    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                let emulator = yield sdk.createEmulator("emulator", api, tag, abi, hardwareProfile, Number(portNumber));
                console.log("starting adb server");
                yield sdk.startAdbServer();
                let booted = yield emulator.start(cmdOptions, +bootTimeout, Number(portNumber));
                if (!booted) {
